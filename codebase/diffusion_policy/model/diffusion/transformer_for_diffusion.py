...
from codebase.diffusion_policy.model.diffusion.positional_embedding import (
    SinusoidalPosEmb,
)
from codebase.diffusion_policy.model.common.module_attr_mixin import ModuleAttrMixin

logger = logging.getLogger(__name__)


class PersonalDM(ModuleAttrMixin):
    def __init__(self, model, n_layer=3):
        super().__init__()
        self.n_layer = n_layer
        self.model = nn.ModuleList([model for _ in range(self.n_layer)])
    ...
    def forward(self, sample, timestep, cond, cls):
        return self.model[cls](sample, timestep, cond)
