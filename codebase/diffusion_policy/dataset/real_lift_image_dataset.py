...
from codebase.diffusion_policy.model.common.normalizer import (
    LinearNormalizer,
    SingleFieldLinearNormalizer,
)
from common.replay_buffer import ReplayBuffer
from codebase.diffusion_policy.common.sampler import (
    SequenceSampler,
    get_val_mask,
    downsample_mask,
)
from codebase.real_world.real_data_conversion import real_data_to_replay_buffer
from codebase.diffusion_policy.common.normalize_util import (
...
class RealLiftImageDataset(BaseImageDataset):
    def __init__(
        self,
        shape_meta: dict,
        dataset_path: str,
...
def _get_replay_buffer(dataset_path, shape_meta, store):
    ...
    lowdim_shapes = dict()
    obs_shape_meta: dict = shape_meta["obs"]
