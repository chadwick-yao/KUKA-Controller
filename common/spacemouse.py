...
class DeviceSpec(object):
    ...
    def __init__(
        ...
        # initialize to a vector of 0s for each state
        self.dict_state = {
            "t": -1,
            "x": 0,
            "y": 0,
        ...
        # initialize to a vector for button_callback_arr timer
    ...
    def open(self):
        ...
        # serial number (byte string) -> hex id
...
def open(
    ...
    if not found_devices:
        ...
        if len(found_devices) > DeviceNumber:
            ...
            new_device: DeviceSpec = copy.deepcopy(spec)
